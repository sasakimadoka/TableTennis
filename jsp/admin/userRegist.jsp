	...
	<div class="py-5 text-black">
		<div class="container">
			<div class="row">
				...
				<div class="col-md-6">
					<h1 class="text-gray-dark">ユーザー登録</h1>
    			  ...
    			  <font color="red">
					...
					<form class="" method="post" action="/TableTennis/jsp/UserRegistServlet">
						<p class="lead">ご希望のIDとパスワードを入力してください</p>
						<%
						...
						<div class="form-group">
						<label>アクター選択</label>
						<input type="radio" name="userRole" value="1"> 大会運営者
						<input type="radio" name="userRole" value="2"> 選手
						</div>
