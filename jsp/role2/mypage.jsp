...
<body>
  ...
  <div class="py-5">
    <div class="container">
      ...
      <div class="row">
        <div class="col-md-6">
        <a class="btn btn-primary w-100" href="/TableTennis/jsp/GoTourSelectServlet?userId=<%=userId%>"><br>出場大会登録<br>&nbsp;</a>
        </div>
        <br>
        <br>
        <div class="col-md-6">
          <a class="btn btn-primary w-100" href="/TableTennis/jsp/WatchGameServlet?userId=<%=userId%>"><br>戦績確認<br>&nbsp;</a>
        </div>
        <br>
        <br>
</div>
